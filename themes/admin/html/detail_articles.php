           ...
           <div class="col-md-12 col-lg-12">
                    ...
                    <div class="btn-group pull-right">
                        ...
                        <a disabled  class="btn btn-primary" style="color: #fff;"><i class="fa fa-plus-sign fa-white"></i> Previous </a>
                            <?php } else {
                                ?> 
                                <a href="<?php echo _admin_url; ?>/detail_articles/articles/rec:<?php echo $this->last_id; ?>&p=<?php echo $this->page-1;?>&co=<?php echo $this->cour; ?>&ch=<?php echo $this->chap; ?>"  class="btn btn-primary"><i class="fa fa-plus-sign fa-white"></i> Previous </a>
                            <?php }
                            ?>
                            <?php
                            ...
                            <?php } else {
                                ?>
                                <a href="<?php echo _admin_url; ?>/detail_articles/articles/rec:<?php echo $this->next_id; ?>&p=<?php echo $this->page+1; ?>&co=<?php echo $this->cour; ?>&ch=<?php echo $this->chap; ?>"  class="btn btn-primary"><i class="fa fa-plus-sign fa-white"></i> Next </a>
                            <?php }
                            ?>
                    ...
                    <h1 style='border-bottom: 0px; margin: 0px; padding-bottom: 4px;'>
                        <strong>Page: <?php echo $this->page ?></strong>
                    </h1>
                    <hr>
                </div>
                ...
                <?php if ($_SESSION['admin_type'] == "super_admin") { ?>
                    <div class="col-md-12 col-lg-12">
                            <a href="<?php echo _admin_url; ?>/edit/articles/rec:<?php echo $this->current_record; ?>&p=<?php echo $this->page; ?>&co=<?php echo $this->record_info['course'];?>&ch=<?php echo $this->record_info['chapter']; ?>" class="btn btn-success btn-lg"><i class="fa fa-edit fa-white"></i> Edit </a>
                            ...
                            <a href="<?php echo _admin_url; ?>/articles?x=<?php echo $this->record_info['course']; ?>&y=<?php echo $this->record_info['chapter']; ?>" class="btn btn-primary btn-lg"><i class="fa fa-reply"></i> Cancel and Go Back</a> 
                            <hr>
                    </div>
...
<script>
    $(document).ready(function(){
      $(".deletebtn").on('click', function () {
            ...
            var co = "<?php echo $this->record_info['course'];?>";
            var ch = "<?php echo $this->record_info['chapter'];?>";
            $(".contentloader").show();
            ...
            if (alertconfirm) {
                $.post('<?php echo _admin_url; ?>/common/actions', {method: "deletearecord", table: table_name, records: record_ids}, function (data) {
                    if (data == 1) {
                        ...
                        window.location.href = '<?php echo _admin_url; ?>/articles?x='+co+'&y='+ch;
                    } else {
