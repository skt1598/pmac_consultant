        ...
        <section class="row">
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <div class="col-md-12 col-lg-12" style="margin-top:0px; padding:0px; padding-top: 20px;">
                    ...
                    <?php if ($this->vars[2] == "schools" && $this->vars[3] == "error") { ?>
                        <script>
                            setTimeout(function () {
                                window.location = '<?php echo _admin_url; ?>/table/schools';
                            }, 3000);
                        </script>
                        <div class="alert alert-danger alertmessage" style="text-align: left;">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                            <div class="panel-heading"><strong>Warning!</strong>  There was some problem importing CSV file..</div>
                        </div>
                        <hr />
                    <?php } ?>

                    <?php if ($this->vars[2] == "schools" && $this->vars[3] == "success") { ?>
                        <script>
                            setTimeout(function () {
                                window.location = '<?php echo _admin_url; ?>/table/schools';
                                //$(".alertmessage").hide();
                        ...
                        <div class="alert alert-success alertmessage" style="text-align: left;">
                            <button type="button" class="close" data-dismiss="alert">&times;</button>
                            <div class="panel-heading"><strong>Success!</strong>  CSV was successfully imported..</div>
                        </div>
                        <hr />
                    <?php } ?>
                    ...
                    if ($this->total_records == 0) {
                        ...
                        <div class="alert alert-danger" style="padding-top: 30px;">
                            ...
                            <?php if (!in_array($this->vars[2], $this->skipped_add_button)) { ?>
                                <p> <a href="<?php echo _admin_url; ?>/add/<?php echo $this->vars[2]; ?>" class="btn btn-danger"><i class="fa fa-plus"></i> Add a Record</a> </p>
                            <?php } ?>
                        </div>
                    <?php } else {
                        ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" style="padding:10px; border-bottom: none" id="myTable">
                                <thead>
                                    <tr>
                                        <th><center>
                                ...
                                <tbody>
                                    ...
                                    <td width="175">
                                        <div class="btn-group btn-group-sm"> 
                                            ...
                                            <a href="<?php echo _admin_url; ?>/articles?x=<?php echo $value['course']; ?>&y=<?php echo $value['id']; ?>" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="" data-original-title="Record Details"><i class="fa fa-list-alt"></i>Pages</a>

                                            <?php } ?>
                                                <?php if(!isset($value['submit_by']) || $value['submit_by'] == "admin"){ ?>
