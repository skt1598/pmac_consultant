...
<section class="row">
    <div class="col-sm-12">
        <section class="row">
            ...
            <?php } ?>
                                            ...
                                            if (in_array($field, $ckeditor_fields)) {
                                                ?>
                                                <textarea class='form-control ckeditor span6' id='<?php echo $value['Field']; ?>' cols='80'  rows='25'  name='data[<?php echo $value['Field']; ?>]'></textarea>
        ...
        <?php } else if ($field_type == 'timestamp' || $field_type == 'datetime' || $field_type == 'date') { ?>
                                            ...
                                            <input type="text" name="data[<?php echo $value['Field']; ?>]" class="form-control datetimepicker1" id="<?php echo $value['Field']; ?>" placeholder=""  value="<?php echo $now->format('Y-m-d H:i:s') ?>">
